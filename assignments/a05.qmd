...
Notice that the names of the columns are not all in the same format, with some being mixed case, others snake_case. This needs to be fixed.
...
## Getting the data ready for ggplot
...
## Tables with dt - prep for mapping
...
```{r}
# view the table in an interactive way using datatable
datatable(locations)
```
